...
CAMPHOR-で『[CAMPHOR- DOWNTIME](https://anchor.fm/camphor-downtime)』という雑談系Podcastを始めました。<br>
...
音声メディア（AM, FM, Podcast）が好きで何年も聴き漁っており、何故か収録や編集も含めて理解しているつもりになっていましたが、やはり作る側になると改めてその難しさや沼の深さに驚かされました。<br>
...
## 公開時
様々な方法があるが、現在CAMPHOR-では[Anchor](https://anchor.fm)というSpotifyが提供するPodcast制作サービスを用いてホスティングや各種プラットフォームへの配信をしている。<br>
アカウント作成時の注意点として、モバイル版Anchorから作成した場合のみSocial login（Single Sign-On）を選択できるが、**一度決定したログイン方法の変更は現状できない**。パスワードリセットから通常のパスワード認証に変更はできると思う。<br>
...
### スマートBGMの追加
BGMを追加することでハム音やホワイトノイズを誤魔化すことができる。<br>
...
![](apple-mobile.jpg)
 ...
 #### Overcast （mobile）
![](overcast-mobile.jpeg)

#### Pocket Casts （mobile）
![](pocketcasts-mobile.jpeg)
...
### 各種プラットフォーム
CAMPHOR-では2022/12/9時点で以下のプラットフォームで購読できるようにしている。<br>
...
- [ITエンジニア志望の学生が聴くべきPodcast](/posts/2020/12/20/podcasts/)
- [2021年に聴いていたPodcast](/posts/2021/12/31/podcasts2021/)

## おわりに
[これ](/posts/2021/12/31/podcasts2021/)の総括にも書いてありますが、ずっとCAMPHOR-でPodcastをやりたいと思っていたので始められて良かったです。
