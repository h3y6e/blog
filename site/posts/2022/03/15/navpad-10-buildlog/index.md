...
このキーボードは、アルファベットや記号が打てる"普通の"キーボードとは違い、フルキーボードのnavigation clusterとnumpadのみを切り出したキーパッドです。<br>
...
![2つの袋](two_pouches.jpg)

### キーボードキット
内容物は以下のようになっています。

![キット](keyboard_kit.jpg)
...
![チルト用 Aluminum feet セット](aluminum_feet_kit.jpg)
...
![QMK Toolbox](qmk_toolbox.png)

![LEDの確認](check_leds.jpg)
...
Gateron Ink Blueを取り付けます。<br>
`0` キー、`+` キー、`Enter` キーを2Uで使う為、スタビライザーも用意します。

![キースイッチ](set_keyswitches.jpg)
...
![ロータリーエンコーダ](rotary_encoder.jpg)

![はんだ付け](soldering.jpg)

### ProMicroカバーの取り付け

![カバー取り付け](cover_mounting.jpg)
...
![ボトムプレート](bottom_plate.jpg)

![aluminum feet](aluminum_feet.jpg)

## 完成
![完成](kansei.jpg)

![完成2](navpad_10_rev1_red.jpg)
