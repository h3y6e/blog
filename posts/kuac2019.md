...
[ソースコードは公開しております](https://github.com/h3y6e/Ameyadar)ので、自分のアカウントにも導入したいという人は使ってみてください。勿論 [@5ebec](https://twitter.com/5ebec) を見ていただいても良いです。
...
### 機能
基本的な機能はbioにもありますが**「[@5ebec](https://twitter.com/5ebec) 宛に京大の講義名（正式名称）をツイートすると単位取得率を教えてくれる」**これだけです。
